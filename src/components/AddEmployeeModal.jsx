...
export default function AddEmployeeModal({ store, manager, onClose, onSuccess }) {
  ...
  const [files,   setFiles]   = useState({ photo: null, aadhar_photo: null, pan_photo: null, id_proof: null, other_doc: null });
  ...
  const handleSubmit = async () => {
    ...
    try {
      const urls = await uploadFiles('employee-documents', {
        ...
        pan_photo: files.pan_photo, id_proof: files.id_proof, other_doc: files.other_doc,
      }, `stores/${store.id}`);
